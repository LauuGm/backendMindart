...
public class ProjectController {
    ...
    public ResponseEntity.BodyBuilder uplaodImage(@RequestParam("imageFile") MultipartFile file) throws IOException {
        ...
        Project img = new Project(file.getOriginalFilename(), file.getContentType(),
    ...
    public Project getImage(@PathVariable("imageName") String imageName) throws IOException {

        final Optional<Project> retrievedImage = imageRepository.findByName(imageName);
        Project img = new Project(retrievedImage.get().getName(), retrievedImage.get().getType(),
